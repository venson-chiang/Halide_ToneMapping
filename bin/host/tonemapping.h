#ifndef HALIDE__bin___host___tonemapping_h
#define HALIDE__bin___host___tonemapping_h
#include <stdint.h>
...
int tonemapping(struct halide_buffer_t *_input_0_buffer, struct halide_buffer_t *_input_1_buffer, struct halide_buffer_t *_input_2_buffer, struct halide_buffer_t *_input_3_buffer, struct halide_buffer_t *_input_4_buffer, struct halide_buffer_t *_input_5_buffer, struct halide_buffer_t *_input_6_buffer, struct halide_buffer_t *_input_7_buffer, struct halide_buffer_t *_input_8_buffer, struct halide_buffer_t *_input_9_buffer, struct halide_buffer_t *_input_10_buffer, struct halide_buffer_t *_input_11_buffer, struct halide_buffer_t *_input_12_buffer, struct halide_buffer_t *_input_13_buffer, struct halide_buffer_t *_input_14_buffer, struct halide_buffer_t *_input_15_buffer, struct halide_buffer_t *_ln_st_buffer, int32_t _P, int32_t _N, int32_t _width, int32_t _height, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int tonemapping_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *tonemapping_metadata();
